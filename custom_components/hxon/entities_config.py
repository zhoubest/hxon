"""How hxon represents HA entities."""
...
def gen_switch_config(
    ...
    """Many domains which Hxon do not support need to be converted to switch. This function makes things easier."""
    return {
        SUFFIX: TOPIC_SUFFIX_SWITCH,
        GENERATE: [generate],
        RESOLVE: [
            (
                # split hxon msg by "#", then take a sub list
                0,  # from this index
                1,  # to this index
...
ENTITIES_CONFIG: dict[str, Any] = {
    ...
    LIGHT_DOMAIN: {
        ...
        GENERATE: [
            ...
            if (has_key(attributes, ATTR_COLOR_TEMP) and attributes[ATTR_COLOR_TEMP] != 0)
    ...
    FAN_DOMAIN: {
        ...
        GENERATE: [
            ...
            lambda state, attributes: min(
                round(attributes[ATTR_PERCENTAGE] / \
                      attributes[ATTR_PERCENTAGE_STEP]), 4
            )
            ...
            (
                ...
                lambda msg, attributes: (
                    ...
                    SERVICE_SET_PERCENTAGE,
                    {
                        ATTR_PERCENTAGE: min(
                            max(msg[1], 1) * \
                            attributes[ATTR_PERCENTAGE_STEP], 100
                        )
                    },
                )
